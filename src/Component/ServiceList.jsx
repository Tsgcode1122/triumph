...
const ServiceList = () => {
  ...
  return (
    <>
      <div className="m-0 p-8 bg-lightC bg-center justify-center text-center sm:px-6   bg-no-repeat max-[320px]:px-4 ixi:px-6 ixr:px-6">
          ...
          {serviceData.map((service, index) => (
            ...
            >
              ...
              <div className="p-2 ">
                ...
                <p className="mb-4 tsgf text-justify min-h-[8rem] xl:min-h-[10rem] p-2 ixi:text-justify ixi:text-[14px] max-[320px]:text-[12px] ixr:text-[14px] ">
